...
import View from "../../../src/views/WorkMedwellPage";
...
export async function GET() {
  ...
  const html =
    process.env.NODE_ENV === "development"
      ? await renderPage(pageFor("work-medwell.html"), View)
      : readFileSync(join(process.cwd(), ".rendered", "work-medwell.html"), "utf8");
