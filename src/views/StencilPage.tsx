...
/** The "/stencil" page, composed from its Framer sections.
 *
    ...
    <body>
      ...
      <div id="main" data-vignesh-hydrate-v2={"{\"routeId\":\"xycOvQH4C\",\"localeId\":\"default\",\"breakpoints\":[{\"hash\":\"uolzns\",\"mediaQuery\":\"(min-width: 1200px)\"},{\"hash\":\"vfp1gk\",\"mediaQuery\":\"(max-width: 1199.98px)\"}]}"} data-vignesh-ssr-released-at="2026-07-06T15:12:41.348Z" data-vignesh-page-optimized-at="2026-07-06T20:11:31.805Z" data-vignesh-generated-page="">
        <Suspense fallback={null}>
          ...
          <div data-vignesh-root="" className="vignesh-jlwWn framer-uolzns" style={{ minHeight: "100vh", width: "auto" }}>
            <Frame1739329357 />
            <div className="vignesh-fdajdr hidden-uolzns">
              <Suspense fallback={null}>
                <a className="vignesh-1by7pxd hidden-uolzns framer-169f9it" data-vignesh-name="Frame 2606774" href="./">
              ...
              <Suspense fallback={null}>
                <a className="vignesh-194ysu9 framer-169f9it" id="194ysu9" href="#" rel="noopener">
                  <svg className="vignesh-iZmZi framer-x8sp8d hidden-uolzns" role="presentation" viewBox="0 0 24 24">
                    <use href="#3559153988" />
                  </svg>
                </a>
              </Suspense>
