...
export default function Section404Page() {
  return (
    <body>
      ...
      {"\n\t\n\t"}
      <div id="main" data-framer-hydrate-v2={"{\"routeId\":\"FVuLWMDBd\",\"localeId\":\"default\",\"breakpoints\":[{\"hash\":\"k5uwb6\",\"mediaQuery\":\"(min-width: 1200px)\"},{\"hash\":\"tkd17c\",\"mediaQuery\":\"(max-width: 1199.98px)\"}]}"} data-framer-ssr-released-at="2026-07-06T15:12:41.348Z" data-framer-page-optimized-at="2026-07-06T20:11:31.361Z" data-framer-generated-page="">
        <Suspense fallback={null}>
          <style data-framer-html-style="" dangerouslySetInnerHTML={{ __html: "html body { background: rgb(255, 255, 255); }" }} />
          <div data-framer-root="" className="framer-t7eg7 framer-k5uwb6" style={{ minHeight: "100vh", width: "auto" }}>
            <div className="framer-jejrq7-container">
              <Suspense fallback={null}>
