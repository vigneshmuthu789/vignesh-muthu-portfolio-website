...
import Frame1739329357 from "@/src/sections/cognitive-tunneling/Frame1739329357";
import HeroSection from "@/src/sections/cognitive-tunneling/HeroSection";
import Variant1 from "@/src/sections/cognitive-tunneling/Variant1";
import Content from "@/src/sections/cognitive-tunneling/Content";
import Frame1739329355 from "@/src/sections/cognitive-tunneling/Frame1739329355";
import Frame1739329356 from "@/src/sections/cognitive-tunneling/Frame1739329356";
import Frame17393293552 from "@/src/sections/cognitive-tunneling/Frame17393293552";
import Frame17393293562 from "@/src/sections/cognitive-tunneling/Frame17393293562";
import Frame17393293572 from "@/src/sections/cognitive-tunneling/Frame17393293572";

/** The "/cognitive_tunneling" page, composed from its vignesh sections.
 *
...
export default function CognitiveTunnelingPage() {
  return (
    <body>
      {"\n\t\n\t"}
        ...
        <Suspense fallback={null}>
          ...
          <div data-vignesh-root="" className="vignesh-7wmRg vignesh-15v8hv5" style={{ minHeight: "100vh", width: "auto" }}>
            ...
            <div className="vignesh-1twm7m4 hidden-15v8hv5">
              ...
              <div className="vignesh-2asnvw">
                <div className="vignesh-1t11muk hidden-15v8hv5" data-vignesh-component-type="RichTextContainer" style={{ transform: "none" }}>
              ...
              <Suspense fallback={null}>
                <a className="vignesh-c1xwtk vignesh-1lghslc" id="c1xwtk" href="#" rel="noopener">
                  <svg className="vignesh-iZmZi vignesh-nwid27 hidden-15v8hv5" role="presentation" viewBox="0 0 24 24">
                    <use href="#3559153988" />
                  </svg>
                </a>
              </Suspense>
            ...
            <HeroSection />
            <div className="vignesh-6081yv">
              <Suspense fallback={null}>
                <div className="vignesh-z7r8n5-container hidden-1gvhrpf">
                  <Variant1 />
                </div>
              </Suspense>
              <Content />
              <div className="vignesh-1aj6dnn hidden-1gvhrpf" data-vignesh-name="Table of Content" />
            </div>
            <div className="ssr-variant hidden-1gvhrpf">
              <div className="vignesh-1swzlvk-container">
