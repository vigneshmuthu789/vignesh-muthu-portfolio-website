    ...
    <div className="vignesh-18oknc3" data-vignesh-name="Content">
      <div className="vignesh-1unbyey" data-vignesh-name="Intro" id="intro">
        <div className="vignesh-1m6k5b7" data-vignesh-name="Zepto Sous-Chef: Designing a Context-Aware Cooking Companion" data-vignesh-component-type="RichTextContainer" style={{ transform: "none" }}>
          <p dir="auto" style={{ "--font-selector": "SW50ZXItQm9sZA==", "--framer-font-size": "56px", "--framer-font-weight": "700", "--framer-letter-spacing": "-0.01em", "--framer-text-color": "rgb(51, 51, 51)" }} className="vignesh-text">
            {"Zepto Sous-Chef:"}
            <span style={{ "--framer-text-color": "rgb(0, 121, 231)" }} className="vignesh-text">
              {" "}
            </span>
          </p>
          <p dir="auto" style={{ "--framer-font-size": "56px", "--framer-letter-spacing": "-0.01em", "--framer-text-color": "rgb(102, 102, 102)" }} className="vignesh-text">
        ...
        <div className="vignesh-13vsq0r" data-vignesh-name="Redesigning Zepto's evening flow to eliminate late-night decision fatigue, bridging the gap between peak dinner inspiration and open-fridge reality." data-vignesh-component-type="RichTextContainer" style={{ transform: "none" }}>
          <p style={{ "--framer-font-size": "20px", "--framer-line-height": "26px" }} className="vignesh-text">
            <span style={{ "--font-selector": "SW50ZXI=", "--framer-font-family": "\"Inter\"", "--framer-font-size": "20px", "--framer-letter-spacing": "-0.01em", "--framer-text-color": "rgba(102, 102, 102, 1)" }} className="vignesh-text">
        ...
        <div className="vignesh-147692" data-vignesh-name="Frame 1739329468">
          <div className="vignesh-1agy9u" data-border="true" data-vignesh-name="Frame 103">
            <div className="vignesh-fu5yik" data-vignesh-name="AI User Experience" data-vignesh-component-type="RichTextContainer" style={{ transform: "none" }}>
              <p style={{ "--framer-font-size": "13px" }} className="vignesh-text">
                <span style={{ "--font-selector": "R0Y7U0YgUHJvLXJlZ3VsYXI=", "--framer-font-family": "\"SF Pro\"", "--framer-font-size": "13px", "--framer-text-color": "rgba(51, 51, 51, 1)" }} className="vignesh-text">
                  {"AI User Experience"}
                </span>
              </p>
            </div>
          ...
          <div className="vignesh-5mlrtt" data-vignesh-name="Frame 1739329469">
            <div className="vignesh-qibtl3" data-vignesh-name="Overview" data-vignesh-component-type="RichTextContainer" style={{ transform: "none" }}>
              <p style={{ "--framer-font-size": "16px" }} className="vignesh-text">
                <span style={{ "--font-selector": "R0Y7Um9ib3RvIE1vbm8tNTAw", "--framer-font-family": "\"Roboto Mono\"", "--framer-font-size": "16px", "--framer-font-weight": "500", "--framer-letter-spacing": "-0.01em", "--framer-text-color": "rgba(102, 102, 102, 1)" }} className="vignesh-text">
                  {"Overview"}
                </span>
              </p>
            </div>
            <div className="vignesh-cm5rmv" data-vignesh-name="The Evening Rush" data-vignesh-component-type="RichTextContainer" style={{ transform: "none" }}>
              <p style={{ "--framer-font-size": "24px" }} className="vignesh-text">
                <span style={{ "--font-selector": "SW50ZXItQm9sZA==", "--framer-font-family": "\"Inter-Bold\", \"Inter\", sans-serif", "--framer-font-size": "24px", "--framer-font-weight": "700", "--framer-text-color": "rgba(51, 51, 51, 1)" }} className="vignesh-text">
                  {"The Evening Rush"}
                </span>
              </p>
            </div>
        ...
        <div className="vignesh-1m75i1" data-border="true" data-vignesh-name="Metricx">
          <div className="vignesh-eg4x5c" data-vignesh-name="01">
            <div className="vignesh-1dw61pb" data-vignesh-name="77%" data-vignesh-component-type="RichTextContainer" style={{ transform: "none" }}>
              <p style={{ "--framer-font-size": "28px", "--framer-line-height": "58px", "--framer-text-alignment": "center" }} className="vignesh-text">
                <span style={{ "--font-selector": "SW50ZXItQm9sZA==", "--framer-font-family": "\"Inter-Bold\", \"Inter\", sans-serif", "--framer-font-size": "28px", "--framer-font-weight": "700", "--framer-text-color": "rgba(51, 51, 51, 1)" }} className="vignesh-text">
                  {"77%"}
                </span>
              </p>
            </div>
            <div className="vignesh-121el19" data-vignesh-name="Frame 1739329471">
              <div className="vignesh-8e6fr9" data-vignesh-name="The 8 PM Fridge Stare" data-vignesh-component-type="RichTextContainer" style={{ transform: "none" }}>
                <p style={{ "--framer-font-size": "16px", "--framer-line-height": "24px", "--framer-text-alignment": "center" }} className="vignesh-text">
                  <span style={{ "--font-selector": "SW50ZXItU2VtaUJvbGQ=", "--framer-font-family": "\"Inter-SemiBold\", \"Inter\", sans-serif", "--framer-font-size": "16px", "--framer-font-weight": "600", "--framer-text-color": "rgba(107, 38, 191, 1)", "--framer-text-transform": "uppercase" }} className="vignesh-text">
              ...
              <div className="vignesh-1lueal0" data-vignesh-name="77% of working adults experience decision fatigue at night. Tired from commutes, they stare at empty shelves and drop off to Zomato/Swiggy food delivery apps." data-vignesh-component-type="RichTextContainer" style={{ transform: "none" }}>
                <p style={{ "--framer-font-size": "16px", "--framer-line-height": "24px", "--framer-text-alignment": "center" }} className="vignesh-text">
                  <span style={{ "--font-selector": "SW50ZXI=", "--framer-font-family": "\"Inter\"", "--framer-font-size": "16px", "--framer-text-color": "rgba(102, 102, 102, 1)" }} className="vignesh-text">
          ...
          <div className="vignesh-5tp3v1" data-vignesh-name="03">
            <div className="vignesh-513v52" data-vignesh-name="₹350+" data-vignesh-component-type="RichTextContainer" style={{ transform: "none" }}>
              <p style={{ "--framer-font-size": "32px", "--framer-line-height": "58px", "--framer-text-alignment": "center" }} className="vignesh-text">
                <span style={{ "--font-selector": "SW50ZXItQm9sZA==", "--framer-font-family": "\"Inter-Bold\", \"Inter\", sans-serif", "--framer-font-size": "28px", "--framer-font-weight": "700", "--framer-text-color": "rgba(51, 51, 51, 1)" }} className="vignesh-text">
                  {"₹350"}
                </span>
                <span style={{ "--font-selector": "SW50ZXItQm9sZA==", "--framer-font-family": "\"Inter-Bold\", \"Inter\", sans-serif", "--framer-font-size": "32px", "--framer-font-weight": "700", "--framer-text-color": "rgba(51, 51, 51, 1)" }} className="vignesh-text">
                  {"+"}
                </span>
              </p>
            </div>
            ...
            <div className="vignesh-1qbtfnz" data-vignesh-name="Frame 1739329470">
              ...
              <div className="vignesh-1yo16dc" data-vignesh-name="Quick-commerce apps assume buying ingredients is transactional. Kitchen interviews with 24 users uncovered three systemic breakdowns." data-vignesh-component-type="RichTextContainer" style={{ transform: "none" }}>
                <p style={{ "--framer-font-size": "16px", "--framer-line-height": "24px" }} className="vignesh-text">
                  <span style={{ "--font-selector": "SW50ZXItTGlnaHQ=", "--framer-font-family": "\"Inter-Light\", \"Inter\", sans-serif", "--framer-font-size": "16px", "--framer-font-weight": "300", "--framer-letter-spacing": "-0.01em", "--framer-text-color": "rgba(51, 51, 51, 1)" }} className="vignesh-text">
        ...
        <div className="vignesh-174bnhf" data-vignesh-name="Frame 1739329479">
          <div className="vignesh-rbmodc" data-border="true" data-vignesh-name="Frame 1739329101">
            <div className="vignesh-s8ko7n" data-vignesh-name="Frame 1739329475">
              ...
              <div className="vignesh-bn1zra" data-vignesh-name="Frame 1739329474">
                <div className="vignesh-jz6bkq" data-vignesh-name="Fragmented Funnels" data-vignesh-component-type="RichTextContainer" style={{ transform: "none" }}>
                  <p style={{ "--framer-font-size": "20px", "--framer-line-height": "26px" }} className="vignesh-text">
                    <span style={{ "--font-selector": "SW50ZXItU2VtaUJvbGQ=", "--framer-font-family": "\"Inter-SemiBold\", \"Inter\", sans-serif", "--framer-font-size": "20px", "--framer-font-weight": "600", "--framer-letter-spacing": "-0.01em", "--framer-text-color": "rgba(102, 102, 102, 1)" }} className="vignesh-text">
                      {"Fragmented Funnels"}
                    </span>
                  </p>
                </div>
                <div className="vignesh-452ube" data-vignesh-name="Users juggle multiple sources just to figure out dinner, creating disjointed sessions." data-vignesh-component-type="RichTextContainer" style={{ transform: "none" }}>
                  <p style={{ "--framer-font-size": "14px", "--framer-line-height": "20px" }} className="vignesh-text">
                    <span style={{ "--font-selector": "SW50ZXI=", "--framer-font-family": "\"Inter\"", "--framer-font-size": "14px", "--framer-letter-spacing": "-0.01em", "--framer-text-color": "rgba(51, 51, 51, 1)" }} className="vignesh-text">
              ...
              <div className="vignesh-1p486jp" data-vignesh-name="Frame 1739329474">
                ...
                <div className="vignesh-izmmny" data-vignesh-name="Insta Reel" data-vignesh-component-type="RichTextContainer" style={{ transform: "none" }}>
                  <p style={{ "--framer-font-size": "12px", "--framer-line-height": "16px" }} className="vignesh-text">
                    <span style={{ "--font-selector": "R0Y7Um9ib3RvIE1vbm8tNTAw", "--framer-font-family": "\"Roboto Mono\"", "--framer-font-size": "12px", "--framer-font-weight": "500", "--framer-letter-spacing": "-0.01em", "--framer-text-color": "rgba(92, 92, 88, 1)" }} className="vignesh-text">
                      {"Insta Reel"}
                    </span>
                  </p>
                </div>
            ...
            <div className="vignesh-zxr18q" data-vignesh-name={"\"I look inside my fridge, look at recipes online, and then manually search on Zepto — nothing feels connected.\""} data-vignesh-component-type="RichTextContainer" style={{ transform: "none" }}>
              <p style={{ "--framer-font-size": "12px", "--framer-line-height": "20px", "--framer-text-alignment": "center" }} className="vignesh-text">
                <span style={{ "--font-selector": "SW50ZXItSXRhbGlj", "--framer-font-family": "\"Inter-Italic\", \"Inter\", sans-serif", "--framer-font-size": "12px", "--framer-font-style": "italic", "--framer-letter-spacing": "-0.01em", "--framer-text-color": "rgba(51, 51, 51, 1)" }} className="vignesh-text">
              ...
              <div className="vignesh-hd6c7w" data-border="true" data-vignesh-name="Frame 1739329476">
                <div className="vignesh-jafae3" data-vignesh-name="Frame 1739329474">
                  ...
                  <div className="vignesh-pwq90q" data-vignesh-name="40% (80g / 200g needed)" data-vignesh-component-type="RichTextContainer" style={{ transform: "none" }}>
                    <p style={{ "--framer-font-size": "12px" }} className="vignesh-text">
                      <span style={{ "--font-selector": "R0Y7Um9ib3RvIE1vbm8tcmVndWxhcg==", "--framer-font-family": "\"Roboto Mono\"", "--framer-font-size": "12px", "--framer-letter-spacing": "-0.01em", "--framer-text-color": "rgba(92, 92, 88, 1)" }} className="vignesh-text">
                        {"40% (80g / 200g needed)"}
                      </span>
                    </p>
                  </div>
                ...
                <div className="vignesh-17h22hj" data-vignesh-name="Frame 1739329474">
                  ...
                  <div className="vignesh-1u4s575" data-vignesh-name="Auto-adding 4 suspected items to checkout basket." data-vignesh-component-type="RichTextContainer" style={{ transform: "none" }}>
                    <p style={{ "--framer-font-size": "12px", "--framer-line-height": "18px" }} className="vignesh-text">
                      <span style={{ "--font-selector": "R0Y7Um9ib3RvIE1vbm8tcmVndWxhcg==", "--framer-font-family": "\"Roboto Mono\"", "--framer-font-size": "12px", "--framer-letter-spacing": "-0.01em", "--framer-text-color": "rgba(138, 138, 133, 1)" }} className="vignesh-text">
        ...
        <div className="vignesh-1tmra1w" data-vignesh-name="Details">
          <div className="vignesh-162oxxs" data-vignesh-name="Frame 1739329469">
            <div className="vignesh-bwydq0" data-vignesh-name="The Path to Dinner" data-vignesh-component-type="RichTextContainer" style={{ transform: "none" }}>
              <p dir="auto" style={{ "--font-selector": "R0Y7Um9ib3RvIE1vbm8tNTAw", "--framer-font-family": "\"Roboto Mono\", monospace", "--framer-font-weight": "500", "--framer-letter-spacing": "-0.01em", "--framer-text-color": "rgb(102, 102, 102)" }} className="vignesh-text">
                {"The Path to Dinner"}
              </p>
            </div>
          ...
          <div className="vignesh-1f2ys1e">
            <div className="ssr-variant">
              <div className="vignesh-5okiih-container" id="content 1">
                <div className="vignesh-3E92k framer-1yvv383 framer-v-1jto3wc" data-border="true" data-vignesh-name="Variant 2" style={{ "--border-bottom-width": "1px", "--border-color": "rgba(230, 230, 230, 0.4)", "--border-left-width": "0px", "--border-right-width": "0px", "--border-style": "solid", "--border-top-width": "0px", width: "100%", opacity: "0.4" }}>
                  <div className="vignesh-1lwbao" data-vignesh-name="01 / Inbound Capture" data-vignesh-component-type="RichTextContainer" style={{ "--extracted-1w3ko1f": "rgba(102, 102, 102, 1)", "--framer-paragraph-spacing": "12px", transform: "none" }}>
                    <p className="vignesh-text" style={{ "--framer-font-size": "16px" }}>
                      <span className="vignesh-text" style={{ "--font-selector": "R0Y7Um9ib3RvIE1vbm8tNTAw", "--framer-font-family": "\"Roboto Mono\"", "--framer-font-size": "16px", "--framer-font-weight": "500", "--framer-letter-spacing": "-0.01em", "--framer-text-color": "var(--extracted-1w3ko1f, rgba(102, 102, 102, 1))" }}>
                        {"01 / Inbound Capture"}
                      </span>
                    </p>
                  </div>
                  <div className="vignesh-1wb3ph7" data-vignesh-name="Frame 1739329516">
                    <div className="vignesh-vsm01c" data-vignesh-name="Fridge Ingestion & Sync" data-vignesh-component-type="RichTextContainer" style={{ "--extracted-1w3ko1f": "rgba(51, 51, 51, 1)", "--framer-paragraph-spacing": "12px", transform: "none" }}>
                      <p className="vignesh-text" style={{ "--framer-font-size": "24px" }}>
                        <span className="vignesh-text" style={{ "--font-selector": "SW50ZXItQm9sZA==", "--framer-font-family": "\"Inter-Bold\", \"Inter\", sans-serif", "--framer-font-size": "24px", "--framer-font-weight": "700", "--framer-text-color": "var(--extracted-1w3ko1f, rgba(51, 51, 51, 1))" }}>
                          {"Fridge Ingestion & Sync"}
                        </span>
                      </p>
                    </div>
                    <div className="vignesh-wc6kw3" data-vignesh-name="An evening home screen card prompts entry. Users scan fridge shelves, paste YouTube links, or import Instagram recipes. Assumed basics toggles skip bulk suggestions." data-vignesh-component-type="RichTextContainer" style={{ "--extracted-1w3ko1f": "rgba(51, 51, 51, 1)", "--framer-paragraph-spacing": "12px", transform: "none" }}>
                      <p className="vignesh-text" style={{ "--framer-font-size": "16px", "--framer-line-height": "24px" }}>
                        <span className="vignesh-text" style={{ "--font-selector": "SW50ZXItTGlnaHQ=", "--framer-font-family": "\"Inter-Light\", \"Inter\", sans-serif", "--framer-font-size": "16px", "--framer-font-weight": "300", "--framer-letter-spacing": "-0.01em", "--framer-text-color": "var(--extracted-1w3ko1f, rgba(51, 51, 51, 1))" }}>
            ...
            <div className="vignesh-9eugst" data-vignesh-name="Warper">
              <div className="ssr-variant hidden-1g4wfox">
                <div className="vignesh-dw1g21-container">
                  <div className="vignesh-C6Owd framer-rzbsme framer-v-rzbsme" data-vignesh-name="1" style={{ height: "100%" }}>
              ...
              <div className="ssr-variant hidden-1uxv7jj">
                <div className="vignesh-dw1g21-container">
                  <div className="vignesh-C6Owd framer-rzbsme framer-v-1bnyxmp" data-vignesh-name="S1" style={{ height: "100%" }}>
                    <div className="vignesh-1o8r35" data-vignesh-name="Phone Mockup">
                      <div className="vignesh-1al0i9y" data-vignesh-name="01 Home">
                        <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }} data-vignesh-background-image-wrapper="true">
            ...
            <div className="vignesh-s7h4d1" data-border="true" data-vignesh-name="Frame 1739329508">
              <div className="vignesh-ko88yr" data-vignesh-name="Frame 1739329392">
                <div className="vignesh-18fgqu0" data-vignesh-name="Skeleton Loading States" data-vignesh-component-type="RichTextContainer" style={{ transform: "none" }}>
                  <p style={{ "--framer-font-size": "24px" }} className="vignesh-text">
                    <span style={{ "--font-selector": "SW50ZXItQm9sZA==", "--framer-font-family": "\"Inter-Bold\", \"Inter\", sans-serif", "--framer-font-size": "24px", "--framer-font-weight": "700", "--framer-letter-spacing": "-0.01em", "--framer-text-color": "rgba(102, 102, 102, 1)" }} className="vignesh-text">
                ...
                <div className="vignesh-ee9v0t" data-vignesh-name={"LLM parsing takes 0.8–1.2s. Skeleton screens maintain system visibility during this window — preventing the \"nothing is happening\" abandonment that kills conversion during scans."} data-vignesh-component-type="RichTextContainer" style={{ transform: "none" }}>
                  <p style={{ "--framer-font-size": "16px" }} className="vignesh-text">
                    <span style={{ "--font-selector": "R0Y7TGF0by1yZWd1bGFy", "--framer-font-family": "\"Lato\"", "--framer-font-size": "16px", "--framer-text-color": "rgba(24, 26, 34, 0.6000000238418579)" }} className="vignesh-text">
        ...
        <div className="vignesh-9illau" data-vignesh-name="Details">
          <div className="vignesh-1mrxsop" data-vignesh-name="Frame 1739329469">
            <div className="vignesh-pgw5ms" data-vignesh-name="Proving the Prototype" data-vignesh-component-type="RichTextContainer" style={{ transform: "none" }}>
              <p dir="auto" style={{ "--font-selector": "R0Y7Um9ib3RvIE1vbm8tNTAw", "--framer-font-family": "\"Roboto Mono\", monospace", "--framer-font-weight": "500", "--framer-letter-spacing": "-0.01em", "--framer-text-color": "rgb(138, 138, 133)" }} className="vignesh-text">
              ...
              <div className="vignesh-1kji9fd" data-vignesh-name="Frame 1739329392">
                <div className="vignesh-xw8mmx" data-vignesh-name="Frame 1739329510">
                  <div className="vignesh-9hc58q" data-vignesh-name="82%" data-vignesh-component-type="RichTextContainer" style={{ transform: "none" }}>
                    <p style={{ "--framer-font-size": "32px" }} className="vignesh-text">
                      <span style={{ "--font-selector": "SW50ZXItQm9sZA==", "--framer-font-family": "\"Inter-Bold\", \"Inter\", sans-serif", "--framer-font-size": "32px", "--framer-font-weight": "700", "--framer-letter-spacing": "-0.01em", "--framer-text-color": "rgba(40, 117, 45, 1)" }} className="vignesh-text">
                        {"82"}
                      </span>
                      <span style={{ "--font-selector": "SW50ZXItQm9sZA==", "--framer-font-family": "\"Inter-Bold\", \"Inter\", sans-serif", "--framer-font-size": "24px", "--framer-font-weight": "700", "--framer-letter-spacing": "-0.01em", "--framer-text-color": "rgba(40, 117, 45, 1)" }} className="vignesh-text">
                        {"%"}
                      </span>
                    </p>
                  </div>
                  <div className="vignesh-1cqwdh6" data-vignesh-name="Usability Score" data-vignesh-component-type="RichTextContainer" style={{ transform: "none" }}>
                    <p style={{ "--framer-font-size": "16px" }} className="vignesh-text">
                      <span style={{ "--font-selector": "SW50ZXItU2VtaUJvbGQ=", "--framer-font-family": "\"Inter-SemiBold\", \"Inter\", sans-serif", "--framer-font-size": "16px", "--framer-font-weight": "600", "--framer-letter-spacing": "-0.01em", "--framer-text-color": "rgba(102, 102, 102, 1)" }} className="vignesh-text">
                        {"Usability Score"}
                      </span>
                    </p>
                  </div>
              ...
              <div className="vignesh-1u4dd23" data-vignesh-name="Frame 1739329392">
                <div className="vignesh-1y405o6" data-vignesh-name="Frame 1739329510">
                  <div className="vignesh-1poboy2" data-vignesh-name="Gemini" data-vignesh-component-type="RichTextContainer" style={{ transform: "none" }}>
                    <p style={{ "--framer-font-size": "32px" }} className="vignesh-text">
                      <span style={{ "--font-selector": "SW50ZXItQm9sZA==", "--framer-font-family": "\"Inter-Bold\", \"Inter\", sans-serif", "--framer-font-size": "32px", "--framer-font-weight": "700", "--framer-letter-spacing": "-0.01em", "--framer-text-color": "rgba(116, 31, 198, 1)" }} className="vignesh-text">
                        {"Gemini"}
                      </span>
                    </p>
                  </div>
