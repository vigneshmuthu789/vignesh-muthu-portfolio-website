...
export default function Frame1739329351() {
  return (
    <div className="vignesh-1ufqvkx" data-border="true" data-vignesh-name="Frame 1739329351">
      <div className="vignesh-kunkd3" data-border="true" data-vignesh-name="Frame 1739329340">
        <div className="ssr-variant hidden-1alp9q5">
          <div data-vignesh-component-type="SVG" data-vignesh-name="Frame 16296" parentsize="0" _constraints="[object Object]" rotation="0" shadows="" className="vignesh-z418qp" aria-hidden="true" style={{ imageRendering: "pixelated", flexShrink: "0", backgroundSize: "100% 100%", backgroundImage: "url('data:image/svg+xml,<svg xmlns=%22http://www.w3.org/2000/svg%22 xmlns:xlink=%22http://www.w3.org/1999/xlink%22 viewBox=%220 0 64 84%22><path d=%22M 52.388 12.136 L 14.13 32.986 C 13.633 33.257 13.667 33.923 14.191 34.15 L 49.431 49.459 C 49.954 49.686 49.989 50.352 49.491 50.623 L 11.104 71.544 C 10.562 71.839 9.891 71.41 10.015 70.847 L 14.541 50.291 C 14.583 50.1 14.716 49.935 14.904 49.842 L 47.103 33.755 C 47.277 33.668 47.405 33.521 47.456 33.346 L 53.466 12.873 C 53.635 12.299 52.949 11.83 52.388 12.136 Z%22 fill=%22transparent%22 stroke-width=%224%22 stroke=%22rgba(51, 51, 51, 0.8)%22 stroke-miterlimit=%2210%22 stroke-dasharray=%22%22></path></svg>')" }} />
        </div>
        <div className="ssr-variant hidden-72rtr7">
          <div data-vignesh-component-type="SVG" data-vignesh-name="Frame 16296" parentsize="0" _constraints="[object Object]" rotation="0" shadows="" className="vignesh-z418qp" aria-hidden="true" style={{ imageRendering: "pixelated", flexShrink: "0", backgroundSize: "100% 100%", backgroundImage: "url('data:image/svg+xml,<svg xmlns=%22http://www.w3.org/2000/svg%22 xmlns:xlink=%22http://www.w3.org/1999/xlink%22 viewBox=%220 0 48 48%22><path d=%22M 39.188 2.11 L 11.039 17.451 C 10.673 17.651 10.698 18.14 11.084 18.308 L 37.012 29.571 C 37.397 29.739 37.422 30.228 37.056 30.428 L 8.812 45.821 C 8.413 46.038 7.92 45.722 8.011 45.308 L 11.341 30.184 C 11.372 30.043 11.47 29.922 11.608 29.853 L 35.299 18.017 C 35.427 17.953 35.521 17.844 35.559 17.716 L 39.981 2.653 C 40.105 2.231 39.6 1.885 39.188 2.11 Z%22 fill=%22transparent%22 stroke-width=%224%22 stroke=%22rgba(51, 51, 51, 0.8)%22 stroke-miterlimit=%2210%22 stroke-dasharray=%22%22></path></svg>')" }} />
        </div>
