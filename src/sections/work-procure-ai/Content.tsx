  ...
  return (
    <div className="vignesh-1tjv76g" data-border="true" data-vignesh-name="Content">
      ...
      <div className="vignesh-1k6x1rk" data-vignesh-name="Impact" id="my-impact">
        ...
        <div className="vignesh-17b5x12" data-vignesh-name="Metricx">
      ...
      <div className="vignesh-ere5ij" data-vignesh-name="Image01">
        <div className="vignesh-r9p19b" data-vignesh-name="Group 15261">
          <div className="ssr-variant">
            <div className="vignesh-10q9lhk" data-vignesh-name="IPP2 1" style={{ height: "auto", aspectRatio: "1.487831456592808" }}>
              <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }} data-vignesh-background-image-wrapper="true">
                <img width="4096" height="2753" sizes="(min-width: 1200px) 717px, (max-width: 1199.98px) calc(100vw - 80px)" srcSet="/assets/img/e8cb7b81eafe60d5.webp 512w, /assets/img/a6be17fdbe5ddfa5.webp 1024w, /assets/img/ee5052f67558e356.webp 2048w, /assets/img/82d9c41e85c73785.webp 4096w" src="/assets/img/82d9c41e85c73785.webp" alt="Procure AI Desktop Mockup 2" style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} loading="eager" />
              </div>
            </div>
          </div>
        </div>
        <div className="vignesh-14bmg69" data-vignesh-name="Frame 1739329097">
          <div className="ssr-variant">
            <div className="vignesh-1iyrjgy" data-vignesh-name="image 74" style={{ height: "auto", aspectRatio: "0.9508474576271186" }}>
              <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }} data-vignesh-background-image-wrapper="true">
                <img width="1122" height="1180" sizes="(min-width: 1200px) 350.5px, (max-width: 1199.98px) max((100vw - 88px) / 2, 1px)" srcSet="/assets/img/7d73ef946e6d9c24.webp 973w, /assets/img/f8d14f68bfdb292e.webp 1122w" src="/assets/img/f8d14f68bfdb292e.webp" alt="Procure AI Logo" style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} loading="eager" />
              </div>
            </div>
          </div>
          <div className="ssr-variant">
            <div className="vignesh-1w4wqj3" data-vignesh-name="image 75" style={{ height: "auto", aspectRatio: "0.9516949152542373" }}>
              <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }} data-vignesh-background-image-wrapper="true">
                <img width="1123" height="1180" sizes="(min-width: 1200px) 350.5px, (max-width: 1199.98px) max((100vw - 88px) / 2, 1px)" srcSet="/assets/img/4b54dd062e07d2bd.webp 974w, /assets/img/8bdeb29c1871c21c.webp 1123w" src="/assets/img/8bdeb29c1871c21c.webp" alt="Glimpes of Procurement in browser" style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} loading="eager" />
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="vignesh-19hf95h" data-vignesh-name="Problem" id="problem">
        ...
        <div className="vignesh-deum6g" data-vignesh-name="Frame 1739329110">
          ...
          <div className="vignesh-15gvmfm" data-vignesh-name="Frame 1739329106">
            <div className="vignesh-a9756">
              <div className="vignesh-1dc0w0z" data-vignesh-name="Frame 1739329101">
                <div data-vignesh-component-type="SVG" data-vignesh-name="PuzzlePiece" parentsize="0" _constraints="[object Object]" rotation="0" shadows="" className="vignesh-1fu3aw7" aria-hidden="true" style={{ imageRendering: "pixelated", flexShrink: "0", fill: "rgba(0,0,0,1)", color: "rgba(0,0,0,1)" }}>
              ...
              <div className="vignesh-mut29e" data-vignesh-name="Frame 1739329102">
                <div data-vignesh-component-type="SVG" data-vignesh-name="ListMagnifyingGlass" parentsize="0" _constraints="[object Object]" rotation="0" shadows="" className="vignesh-kd5v9w" aria-hidden="true" style={{ imageRendering: "pixelated", flexShrink: "0", fill: "rgba(0,0,0,1)", color: "rgba(0,0,0,1)" }}>
                  <div className="svgContainer" style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
                    <svg style={{ width: "100%", height: "100%" }} viewBox="0 0 64 64">
                      <use href="#svg2062849050_1270" />
                    </svg>
                  </div>
                </div>
              ...
              <div className="vignesh-1umjlau" data-vignesh-name="Frame 1739329104">
                <div className="vignesh-17fh3r5" data-vignesh-name="MagnifyingGlass">
                  <div data-vignesh-component-type="SVG" data-vignesh-name="Vector" parentsize="0" _constraints="[object Object]" rotation="0" shadows="" className="vignesh-y6owqr" aria-hidden="true" style={{ imageRendering: "pixelated", flexShrink: "0", fill: "rgba(0,0,0,1)", color: "rgba(0,0,0,1)" }}>
                    <div className="svgContainer" style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
                      <svg style={{ width: "100%", height: "100%" }} viewBox="0 0 44 44">
                        <use href="#svg605418241_395" />
                      </svg>
                    </div>
                  </div>
                  <div data-vignesh-component-type="SVG" data-vignesh-name="Vector" parentsize="0" _constraints="[object Object]" rotation="0" shadows="" className="vignesh-1gb2c4u" aria-hidden="true" style={{ imageRendering: "pixelated", flexShrink: "0", fill: "rgba(0,0,0,1)", color: "rgba(0,0,0,1)" }}>
                    <div className="svgContainer" style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
                      <svg style={{ width: "100%", height: "100%" }} viewBox="0 0 18 18">
                        <use href="#svg132120833_306" />
                      </svg>
                    </div>
                  </div>
            ...
            <div className="vignesh-1vcnwlf">
              <div className="vignesh-r4a8tk" data-vignesh-name="Frame 1739329103">
                <div data-vignesh-component-type="SVG" data-vignesh-name="LinkBreak" parentsize="0" _constraints="[object Object]" rotation="0" shadows="" className="vignesh-3bx9ax" aria-hidden="true" style={{ imageRendering: "pixelated", flexShrink: "0", fill: "rgba(0,0,0,1)", color: "rgba(0,0,0,1)" }}>
                  <div className="svgContainer" style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
                    <svg style={{ width: "100%", height: "100%" }} viewBox="0 0 64 64">
              ...
              <div className="vignesh-i2nfda" data-vignesh-name="Frame 1739329105">
                <div data-vignesh-component-type="SVG" data-vignesh-name="Warning" parentsize="0" _constraints="[object Object]" rotation="0" shadows="" className="vignesh-1jbng1o" aria-hidden="true" style={{ imageRendering: "pixelated", flexShrink: "0", fill: "rgba(0,0,0,1)", color: "rgba(0,0,0,1)" }}>
                  <div className="svgContainer" style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
                    <svg style={{ width: "100%", height: "100%" }} viewBox="0 0 64 64">
                      <use href="#svg-1689537507_881" />
                    </svg>
                  </div>
                </div>
      ...
      <div className="vignesh-b3ktjl" data-vignesh-name="Frame 1739329101" id="highlights">
        ...
        <div className="vignesh-9fkth0" data-vignesh-name="Frame 1739329109">
          ...
          <div className="vignesh-18c93ly" data-vignesh-name="Rectangle 13">
            <div className="vignesh-1nt0h1g-container">
              <Suspense fallback={null}>
                <div className="ssr-variant">
                  <video src="/assets/media/77bdf6ceb9be056a.mp4" loop preload="none" muted playsInline style={{ cursor: "auto", width: "100%", height: "100%", borderRadius: "0px", display: "block", objectFit: "cover", backgroundColor: "rgba(0, 0, 0, 0)", objectPosition: "50% 50%" }} />
                </div>
              </Suspense>
            </div>
          </div>
        ...
        <div className="vignesh-1ra245a" data-vignesh-name="Frame 1739329110">
          ...
          <div className="vignesh-khjiro" data-vignesh-name="Rectangle 13">
            <div className="vignesh-kiipqk-container">
              <Suspense fallback={null}>
                <div className="ssr-variant">
                  <video src="/assets/media/6bfddb70de926594.mp4" loop preload="none" muted playsInline style={{ cursor: "auto", width: "100%", height: "100%", borderRadius: "0px", display: "block", objectFit: "cover", backgroundColor: "rgba(0, 0, 0, 0)", objectPosition: "50% 50%" }} />
                </div>
              </Suspense>
            </div>
          </div>
        ...
        <div className="vignesh-m4jjq6" data-vignesh-name="Frame 1739329111">
          ...
          <div className="vignesh-1l6mo42" data-vignesh-name="Rectangle 13">
            <div className="vignesh-c552pv-container">
              <Suspense fallback={null}>
                <div className="ssr-variant">
                  <video src="/assets/media/a0859a2d5c8a61e0.mp4" loop preload="none" muted playsInline style={{ cursor: "auto", width: "100%", height: "100%", borderRadius: "0px", display: "block", objectFit: "cover", backgroundColor: "rgba(0, 0, 0, 0)", objectPosition: "50% 50%" }} />
                </div>
              </Suspense>
            </div>
          </div>
        ...
        <div className="vignesh-aqi4bz" data-vignesh-name="Frame 1739329112">
          ...
          <div className="vignesh-1sn99nj" data-vignesh-name="Rectangle 13">
            <div className="vignesh-1iskcea-container">
              <Suspense fallback={null}>
                <div className="ssr-variant">
                  <video src="/assets/media/cd89f38fd7818657.mp4" loop preload="none" muted playsInline style={{ cursor: "auto", width: "100%", height: "100%", borderRadius: "0px", display: "block", objectFit: "cover", backgroundColor: "rgba(0, 0, 0, 0)", objectPosition: "50% 50%" }} />
                </div>
              </Suspense>
            </div>
          </div>
      ...
      <div className="vignesh-w8ib9f" data-border="true" data-vignesh-name="Frame 1739329102">
        <div className="vignesh-arlysv-container" data-vignesh-appear-id="arlysv" style={{ willChange: "transform", opacity: "0.001", transform: "none" }}>
          <Suspense fallback={null}>
      ...
      <div className="vignesh-rdbscy" data-vignesh-name="Frame 1739329291" id="insights">
        ...
        <div className="vignesh-uj7njx" data-vignesh-name="Frame 1739329290">
          <div className="vignesh-16oruqu" data-vignesh-name="Frame 1739329289">
            ...
            <div className="vignesh-f74kqk" data-vignesh-name="Frame 1739329286">
              ...
              <div className="vignesh-5etkyf" data-vignesh-name="unsplash:j3lf-Jn6deo" style={{ width: "auto", aspectRatio: "0.94" }}>
                <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }} data-vignesh-background-image-wrapper="true">
                  <img decoding="async" width="752" height="800" sizes="(min-width: 1200px) 189.41px, (max-width: 1199.98px) 189.41px" srcSet="/assets/img/6dcc1f4d1ff60b83.webp 752w" src="/assets/img/6dcc1f4d1ff60b83.webp" alt="Walter W" style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "contain" }} loading="lazy" />
                </div>
              </div>
            </div>
          </div>
          <div className="vignesh-zi0bua" data-vignesh-name="Frame 1739329288">
            <div className="vignesh-1onped3" data-vignesh-name="Frame 1739329287">
              <div className="vignesh-1x3pvqz" data-vignesh-name="Frame 1739329117">
              ...
              <div className="vignesh-1ecm7u" data-vignesh-name="Frame 1739329118">
            ...
            <div className="vignesh-19vexu3" data-vignesh-name="Frame 1739329284">
              ...
              <div className="vignesh-shcvqe" data-vignesh-name="Frame 1739329283">
                ...
                <div className="vignesh-nqhy6p" data-border="true" data-vignesh-name="Container">
                  ...
                  <div data-vignesh-component-type="SVG" data-vignesh-name="Container" parentsize="0" _constraints="[object Object]" rotation="0" shadows="" className="vignesh-szkvay" aria-hidden="true" style={{ imageRendering: "pixelated", flexShrink: "0", fill: "rgba(0,0,0,1)", color: "rgba(0,0,0,1)" }}>
                    <div className="svgContainer" style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
                      <svg style={{ width: "100%", height: "100%" }} viewBox="0 0 157 24">
                        <use href="#svg768560081_8288" />
                      </svg>
                    </div>
                  </div>
                </div>
                <div className="vignesh-1x1nte8" data-border="true" data-vignesh-name="Container">
                  ...
                  <div data-vignesh-component-type="SVG" data-vignesh-name="Container" parentsize="0" _constraints="[object Object]" rotation="0" shadows="" className="vignesh-1cg74j7" aria-hidden="true" style={{ imageRendering: "pixelated", flexShrink: "0", fill: "rgba(0,0,0,1)", color: "rgba(0,0,0,1)" }}>
                    <div className="svgContainer" style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
                      <svg style={{ width: "100%", height: "100%" }} viewBox="0 0 157 24">
                        <use href="#svg702675692_5501" />
                      </svg>
                    </div>
                  </div>
                </div>
                <div className="vignesh-16mcwtn" data-border="true" data-vignesh-name="Container">
                  ...
                  <div data-vignesh-component-type="SVG" data-vignesh-name="Container" parentsize="0" _constraints="[object Object]" rotation="0" shadows="" className="vignesh-2urmto" aria-hidden="true" style={{ imageRendering: "pixelated", flexShrink: "0", fill: "rgba(0,0,0,1)", color: "rgba(0,0,0,1)" }}>
                    <div className="svgContainer" style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
                      <svg style={{ width: "100%", height: "100%" }} viewBox="0 0 157 24">
                        <use href="#svg427289743_7356" />
                      </svg>
                    </div>
                  </div>
                </div>
                <div className="vignesh-15bfu1g" data-border="true" data-vignesh-name="Container">
                  ...
                  <div data-vignesh-component-type="SVG" data-vignesh-name="Container" parentsize="0" _constraints="[object Object]" rotation="0" shadows="" className="vignesh-l2nacs" aria-hidden="true" style={{ imageRendering: "pixelated", flexShrink: "0", fill: "rgba(0,0,0,1)", color: "rgba(0,0,0,1)" }}>
                    <div className="svgContainer" style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
                      <svg style={{ width: "100%", height: "100%" }} viewBox="0 0 157 24">
                        <use href="#svg-1408255365_5962" />
                      </svg>
                    </div>
                  </div>
                </div>
                <div className="vignesh-tajwyw" data-border="true" data-vignesh-name="Container">
                  ...
                  <div data-vignesh-component-type="SVG" data-vignesh-name="Container" parentsize="0" _constraints="[object Object]" rotation="0" shadows="" className="vignesh-1cojylt" aria-hidden="true" style={{ imageRendering: "pixelated", flexShrink: "0", fill: "rgba(0,0,0,1)", color: "rgba(0,0,0,1)" }}>
                    <div className="svgContainer" style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
                      <svg style={{ width: "100%", height: "100%" }} viewBox="0 0 157 24">
                        <use href="#svg768560081_8288" />
                      </svg>
                ...
                <div className="vignesh-99otwp" data-border="true" data-vignesh-name="Container">
                  ...
                  <div data-vignesh-component-type="SVG" data-vignesh-name="Container" parentsize="0" _constraints="[object Object]" rotation="0" shadows="" className="vignesh-1vmavyx" aria-hidden="true" style={{ imageRendering: "pixelated", flexShrink: "0", fill: "rgba(0,0,0,1)", color: "rgba(0,0,0,1)" }}>
                    <div className="svgContainer" style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
                      <svg style={{ width: "100%", height: "100%" }} viewBox="0 0 157 24">
                        <use href="#svg-211511008_6426" />
                      </svg>
                    </div>
                  </div>
                </div>
                <div className="vignesh-1ydejx8" data-border="true" data-vignesh-name="Container">
                  ...
                  <div data-vignesh-component-type="SVG" data-vignesh-name="Container" parentsize="0" _constraints="[object Object]" rotation="0" shadows="" className="vignesh-bsq5oc" aria-hidden="true" style={{ imageRendering: "pixelated", flexShrink: "0", fill: "rgba(0,0,0,1)", color: "rgba(0,0,0,1)" }}>
                    <div className="svgContainer" style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
                      <svg style={{ width: "100%", height: "100%" }} viewBox="0 0 157 24">
                        <use href="#svg-1942449968_5963" />
                      </svg>
                    </div>
                  </div>
                </div>
                <div className="vignesh-1ulv7v1" data-border="true" data-vignesh-name="Container">
                  ...
                  <div data-vignesh-component-type="SVG" data-vignesh-name="Container" parentsize="0" _constraints="[object Object]" rotation="0" shadows="" className="vignesh-1hhjisu" aria-hidden="true" style={{ imageRendering: "pixelated", flexShrink: "0", fill: "rgba(0,0,0,1)", color: "rgba(0,0,0,1)" }}>
                    <div className="svgContainer" style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
                      <svg style={{ width: "100%", height: "100%" }} viewBox="0 0 157 24">
                        <use href="#svg768560081_8288" />
                      </svg>
      ...
      <div className="vignesh-1w3q98f" data-vignesh-name="Frame 1739329292" id="solution">
        ...
        <div className="vignesh-3asexu" data-vignesh-name="Frame 1739329305">
          <div className="vignesh-1vsvinn" data-vignesh-name="Frame 1739329302">
            <div className="vignesh-7lh4pg" data-vignesh-name="Frame 1739329293">
              ...
              <div data-vignesh-component-type="SVG" data-vignesh-name="Shovel" parentsize="0" _constraints="[object Object]" rotation="0" shadows="" className="vignesh-12zfxvy" aria-hidden="true" style={{ imageRendering: "pixelated", flexShrink: "0", fill: "rgba(0,0,0,1)", color: "rgba(0,0,0,1)" }}>
                <div className="svgContainer" style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
            ...
            <div className="vignesh-1kmnsiz" data-vignesh-name="Frame 1739329295">
              <div className="vignesh-99qik1" data-vignesh-name="Frame 1739329301">
                <div className="vignesh-eomzdl" data-vignesh-name="Frame 1739329298">
                  <div data-vignesh-component-type="SVG" data-vignesh-name="PuzzlePiece" parentsize="0" _constraints="[object Object]" rotation="0" shadows="" className="vignesh-16v59cw" aria-hidden="true" style={{ imageRendering: "pixelated", flexShrink: "0", fill: "rgba(0,0,0,1)", color: "rgba(0,0,0,1)" }}>
                    <div className="svgContainer" style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
                      <svg style={{ width: "100%", height: "100%" }} viewBox="0 0 16 16">
                        <use href="#svg-864888136_1873" />
                      </svg>
                    </div>
                  </div>
                ...
                <div className="vignesh-s9qjw9" data-vignesh-name="Frame 1739329299">
                  <div data-vignesh-component-type="SVG" data-vignesh-name="SealCheck" parentsize="0" _constraints="[object Object]" rotation="0" shadows="" className="vignesh-1vyx4gb" aria-hidden="true" style={{ imageRendering: "pixelated", flexShrink: "0", fill: "rgba(0,0,0,1)", color: "rgba(0,0,0,1)" }}>
                    <div className="svgContainer" style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
                      <svg style={{ width: "100%", height: "100%" }} viewBox="0 0 16 16">
                        <use href="#svg1058559737_2128" />
                      </svg>
                    </div>
                  </div>
            ...
            <div className="vignesh-18e9f3q" data-vignesh-name="Frame 1739329296">
              <div className="vignesh-qokh4j" data-vignesh-name="Frame 1739329300">
                <div className="vignesh-dlarvl" data-vignesh-name="Frame 1739329298">
                  <div data-vignesh-component-type="SVG" data-vignesh-name="ListMagnifyingGlass" parentsize="0" _constraints="[object Object]" rotation="0" shadows="" className="vignesh-1y3s1jy" aria-hidden="true" style={{ imageRendering: "pixelated", flexShrink: "0", fill: "rgba(0,0,0,1)", color: "rgba(0,0,0,1)" }}>
                    <div className="svgContainer" style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
                      <svg style={{ width: "100%", height: "100%" }} viewBox="0 0 16 16">
                        <use href="#svg1566364477_1070" />
                      </svg>
                    </div>
                  </div>
                ...
                <div className="vignesh-1mid75q" data-vignesh-name="Frame 1739329299">
                  <div data-vignesh-component-type="SVG" data-vignesh-name="SealCheck" parentsize="0" _constraints="[object Object]" rotation="0" shadows="" className="vignesh-1p2gizy" aria-hidden="true" style={{ imageRendering: "pixelated", flexShrink: "0", fill: "rgba(0,0,0,1)", color: "rgba(0,0,0,1)" }}>
                    <div className="svgContainer" style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
                      <svg style={{ width: "100%", height: "100%" }} viewBox="0 0 16 16">
                        <use href="#svg1875900059_1350" />
                      </svg>
                    </div>
                  </div>
          ...
          <div className="vignesh-lbyyf1" data-vignesh-name="Frame 1739329303">
            ...
            <div className="vignesh-1ejii05" data-vignesh-name="Frame 1739329294">
              ...
              <div data-vignesh-component-type="SVG" data-vignesh-name="SketchLogo" parentsize="0" _constraints="[object Object]" rotation="0" shadows="" className="vignesh-9dlt8p" aria-hidden="true" style={{ imageRendering: "pixelated", flexShrink: "0", fill: "rgba(0,0,0,1)", color: "rgba(0,0,0,1)" }}>
                <div className="svgContainer" style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
                  <svg style={{ width: "100%", height: "100%" }} viewBox="0 0 32 32">
      ...
      <div className="vignesh-s5eqw8" data-vignesh-name="Frame 1739329294" id="ideation">
        ...
        <div className="vignesh-14rqe1" data-vignesh-name="Frame 1739329330">
          ...
          <div className="vignesh-1g4ztak" data-vignesh-name="Frame 1739329329">
            <div className="ssr-variant hidden-1af4ja5">
              <div className="vignesh-jloeez" data-vignesh-name="Frame 1739329326" style={{ width: "auto", aspectRatio: "0.9260204081632653" }}>
                <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }} data-vignesh-background-image-wrapper="true">
                  <img decoding="async" width="1089" height="1176" sizes="(min-width: 1200px) 350.4987px, (max-width: 1199.98px) calc(100vw - 80px)" srcSet="/assets/img/fd0d177e0fba70dc.webp 948w, /assets/img/330f96bfbf3f4a59.webp 1089w" src="/assets/img/330f96bfbf3f4a59.webp" alt="Simple Login" style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} loading="lazy" />
                </div>
              </div>
            </div>
            <div className="ssr-variant hidden-16q6qgd">
              <div className="vignesh-jloeez" data-vignesh-name="Frame 1739329326" style={{ height: "auto", aspectRatio: "0.9260204081632653" }}>
                <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }} data-vignesh-background-image-wrapper="true">
                  <img decoding="async" width="1089" height="1176" sizes="(min-width: 1200px) 350.4987px, (max-width: 1199.98px) calc(100vw - 80px)" srcSet="/assets/img/fd0d177e0fba70dc.webp 948w, /assets/img/330f96bfbf3f4a59.webp 1089w" src="/assets/img/330f96bfbf3f4a59.webp" alt="Simple Login" style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} loading="lazy" />
                </div>
              </div>
            ...
            <div className="ssr-variant hidden-1af4ja5">
              <div className="vignesh-1ds2wi0" data-vignesh-name="Frame 1739329327" style={{ width: "auto", aspectRatio: "0.9260204081632653" }}>
                <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }} data-vignesh-background-image-wrapper="true">
                  <img decoding="async" width="1089" height="1176" sizes="(min-width: 1200px) 350.4987px, (max-width: 1199.98px) calc(100vw - 80px)" srcSet="/assets/img/dd8c31beeb9c2de6.webp 948w, /assets/img/cb9d1beb56a992d9.webp 1089w" src="/assets/img/cb9d1beb56a992d9.webp" alt="Stepper Modal" style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} loading="lazy" />
                </div>
              </div>
            </div>
            <div className="ssr-variant hidden-16q6qgd">
              <div className="vignesh-1ds2wi0" data-vignesh-name="Frame 1739329327" style={{ height: "auto", aspectRatio: "0.9260204081632653" }}>
                <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }} data-vignesh-background-image-wrapper="true">
                  <img decoding="async" width="1089" height="1176" sizes="(min-width: 1200px) 350.4987px, (max-width: 1199.98px) calc(100vw - 80px)" srcSet="/assets/img/dd8c31beeb9c2de6.webp 948w, /assets/img/cb9d1beb56a992d9.webp 1089w" src="/assets/img/cb9d1beb56a992d9.webp" alt="Stepper Modal" style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} loading="lazy" />
                </div>
              </div>
          ...
          <div className="ssr-variant hidden-1af4ja5">
            <div className="vignesh-yfm5mh" data-vignesh-name="Frame 1739329328" style={{ width: "auto", aspectRatio: "1.8928571428571428" }}>
              <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }} data-vignesh-background-image-wrapper="true">
                <img decoding="async" width="2226" height="1176" sizes="(min-width: 1200px) 717.3929px, (max-width: 1199.98px) calc(100vw - 80px)" srcSet="/assets/img/cc3cf109b9109751.webp 512w, /assets/img/db14a0a56ed00ece.webp 1024w, /assets/img/67ed494d90cd5477.webp 2048w, /assets/img/81ac708c0f956a7d.webp 2226w" src="/assets/img/81ac708c0f956a7d.webp" alt="" style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} loading="lazy" />
              </div>
            </div>
          </div>
          <div className="ssr-variant hidden-16q6qgd">
            <div className="vignesh-yfm5mh" data-vignesh-name="Frame 1739329328" style={{ height: "auto", aspectRatio: "1.8928571428571428" }}>
              <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }} data-vignesh-background-image-wrapper="true">
                <img decoding="async" width="2226" height="1176" sizes="(min-width: 1200px) 717.3929px, (max-width: 1199.98px) calc(100vw - 80px)" srcSet="/assets/img/cc3cf109b9109751.webp 512w, /assets/img/db14a0a56ed00ece.webp 1024w, /assets/img/67ed494d90cd5477.webp 2048w, /assets/img/81ac708c0f956a7d.webp 2226w" src="/assets/img/81ac708c0f956a7d.webp" alt="" style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} loading="lazy" />
              </div>
            </div>
        ...
        <div className="vignesh-88wi1o" data-vignesh-name="Frame 1739329331">
          ...
          <div className="ssr-variant">
            <div className="vignesh-too6wi" data-vignesh-name="Frame 1739329333" style={{ height: "auto", aspectRatio: "1.5268817204301075" }}>
              <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }} data-vignesh-background-image-wrapper="true">
                <img decoding="async" width="2130" height="1395" sizes="(min-width: 1200px) 717px, (max-width: 1199.98px) calc(100vw - 80px)" srcSet="/assets/img/bf1c5ff7fb026201.webp 512w, /assets/img/26160111579633ca.webp 1024w, /assets/img/7aeede179a4790bf.webp 2048w, /assets/img/41d9c6e34fedbe29.webp 2130w" src="/assets/img/41d9c6e34fedbe29.webp" alt="Lo to Hifi Dashboard Versions" style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} loading="lazy" />
              </div>
            </div>
          </div>
        </div>
        <div className="vignesh-12bimpv" data-vignesh-name="Frame 1739329332">
          ...
          <div className="ssr-variant">
            <div className="vignesh-dfpyi8" data-vignesh-name="Frame 1739329334" style={{ height: "auto", aspectRatio: "1.1299045599151645" }}>
              <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }} data-vignesh-background-image-wrapper="true">
                <img decoding="async" width="2131" height="1886" sizes="(min-width: 1200px) 717px, (max-width: 1199.98px) calc(100vw - 80px)" srcSet="/assets/img/1274e721f5896dae.webp 512w, /assets/img/8b32d00dffb89321.webp 1024w, /assets/img/93db0f6b9b951116.webp 2048w, /assets/img/cf1d2354f6f21513.webp 2131w" src="/assets/img/cf1d2354f6f21513.webp" alt="Offer Analysis Scenario Selection" style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} loading="lazy" />
              </div>
            </div>
          </div>
          <div className="ssr-variant hidden-1af4ja5">
            <div className="vignesh-1y0lb1r" data-vignesh-name="Frame 1739329335">
              <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }} data-vignesh-background-image-wrapper="true">
                <img decoding="async" width="2131" height="1886" sizes="(min-width: 1200px) 717px, (max-width: 1199.98px) calc(100vw - 80px)" srcSet="/assets/img/f0d7ce77f5210f2c.webp 512w, /assets/img/984e53fcf4440b66.webp 1024w, /assets/img/d2c34464408a9b20.webp 2048w, /assets/img/a5316495a9bf6fc2.webp 2131w" src="/assets/img/a5316495a9bf6fc2.webp" alt="Offer Anlysis with AI Driven Scenario" style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} loading="lazy" />
              </div>
            </div>
          </div>
          <div className="ssr-variant hidden-16q6qgd">
            <div className="vignesh-1y0lb1r" data-vignesh-name="Frame 1739329335" style={{ height: "auto", aspectRatio: "1.1299045599151645" }}>
              <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }} data-vignesh-background-image-wrapper="true">
                <img decoding="async" width="2131" height="1886" sizes="(min-width: 1200px) 717px, (max-width: 1199.98px) calc(100vw - 80px)" srcSet="/assets/img/f0d7ce77f5210f2c.webp 512w, /assets/img/984e53fcf4440b66.webp 1024w, /assets/img/d2c34464408a9b20.webp 2048w, /assets/img/a5316495a9bf6fc2.webp 2131w" src="/assets/img/a5316495a9bf6fc2.webp" alt="Offer Anlysis with AI Driven Scenario" style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "cover" }} loading="lazy" />
              </div>
            </div>
      ...
      <div className="vignesh-1tlbs0p" data-vignesh-name="Frame 1739329295" id="final-design">
        ...
        <div className="vignesh-1jyue0f" data-vignesh-name="Frame 1739329338">
          <div className="vignesh-1ygpeff" data-vignesh-name="Frame 1739329336">
            <div className="ssr-variant">
              <div className="vignesh-31maqf" data-border="true" data-vignesh-name="Rectangle 34624633" style={{ height: "auto", aspectRatio: "1.41796875" }}>
                <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }} data-vignesh-background-image-wrapper="true">
                  <img decoding="async" width="1452" height="1024" sizes="(min-width: 1200px) 350.5px, (max-width: 1199.98px) max((100vw - 96px) / 2, 1px)" srcSet="/assets/img/6c8991387ac73078.webp 512w, /assets/img/c6de8c04266ddb06.webp 1024w, /assets/img/86f577768dd1a262.webp 1452w" src="/assets/img/86f577768dd1a262.webp" alt="RFX Supplier & Part View" style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "fill" }} loading="lazy" />
                </div>
              </div>
            </div>
            <div className="ssr-variant">
              <div className="vignesh-1o8t3mm" data-border="true" data-vignesh-name="Rectangle 34624636" style={{ height: "auto", aspectRatio: "1.41796875" }}>
                <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }} data-vignesh-background-image-wrapper="true">
                  <img decoding="async" width="1452" height="1024" sizes="(min-width: 1200px) 350.5px, (max-width: 1199.98px) max((100vw - 96px) / 2, 1px)" srcSet="/assets/img/3e5fd63c397e4e82.webp 512w, /assets/img/b984a33ea650fb24.webp 1024w, /assets/img/d44c0fd26c334e61.webp 1452w" src="/assets/img/d44c0fd26c334e61.webp" alt="AI Driven Rule Creation" style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "fill" }} loading="lazy" />
                </div>
              </div>
            </div>
          </div>
          <div className="vignesh-yuxq4x" data-vignesh-name="Frame 1739329337">
            <div className="ssr-variant">
              <div className="vignesh-1nnrsfl" data-border="true" data-vignesh-name="Rectangle 34624634" style={{ height: "auto", aspectRatio: "0.92578125" }}>
                <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }} data-vignesh-background-image-wrapper="true">
                  <img decoding="async" width="948" height="1024" sizes="(min-width: 1200px) 228.3333px, (max-width: 1199.98px) max((100vw - 112px) / 3, 1px)" srcSet="/assets/img/6985d3a3925c0a44.webp 948w" src="/assets/img/6985d3a3925c0a44.webp" alt="RFX Tablw" style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "fill" }} loading="lazy" />
                </div>
              </div>
            </div>
            <div className="ssr-variant">
              <div className="vignesh-1i0oed3" data-border="true" data-vignesh-name="Rectangle 34624637" style={{ height: "auto", aspectRatio: "0.921875" }}>
                <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }} data-vignesh-background-image-wrapper="true">
                  <img decoding="async" width="944" height="1024" sizes="(min-width: 1200px) 228.3333px, (max-width: 1199.98px) max((100vw - 112px) / 3, 1px)" srcSet="/assets/img/da1eb0d16bda7ab0.webp 944w" src="/assets/img/da1eb0d16bda7ab0.webp" alt="Collabrators" style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "fill" }} loading="lazy" />
                </div>
              </div>
            </div>
            <div className="ssr-variant">
              <div className="vignesh-ch0uii" data-border="true" data-vignesh-name="Rectangle 34624638" style={{ height: "auto", aspectRatio: "0.92578125" }}>
                <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }} data-vignesh-background-image-wrapper="true">
                  <img decoding="async" width="948" height="1024" sizes="(min-width: 1200px) 228.3333px, (max-width: 1199.98px) max((100vw - 112px) / 3, 1px)" srcSet="/assets/img/6e8e674c7fe8e1e0.webp 948w" src="/assets/img/6e8e674c7fe8e1e0.webp" alt="Import File Drawer" style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "fill" }} loading="lazy" />
                </div>
              </div>
            </div>
          </div>
          <div className="ssr-variant">
            <div className="vignesh-1749ts6" data-border="true" data-vignesh-name="Rectangle 34624635" style={{ height: "auto", aspectRatio: "2.90234375" }}>
              <div style={{ position: "absolute", borderRadius: "inherit", cornerShape: "inherit", top: "0", right: "0", bottom: "0", left: "0" }} data-vignesh-background-image-wrapper="true">
                <img decoding="async" width="2972" height="1024" sizes="(min-width: 1200px) 717px, (max-width: 1199.98px) calc(100vw - 80px)" srcSet="/assets/img/267e92f0ce32bdee.webp 512w, /assets/img/5fd3355b357b78db.webp 1024w, /assets/img/5acef03c965fceb0.webp 2048w, /assets/img/95c1631412a08f4d.webp 2972w" src="/assets/img/95c1631412a08f4d.webp" alt="Opportunity Hub" style={{ display: "block", width: "100%", height: "100%", borderRadius: "inherit", cornerShape: "inherit", objectPosition: "center", objectFit: "fill" }} loading="lazy" />
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="vignesh-bce2sw" data-vignesh-name="Frame 1739329296" id="learnings">
        ...
        <div className="vignesh-ywkhsl" data-vignesh-name="Frame 1739329361">
          <div className="vignesh-1bpn93k">
            <div className="vignesh-gmt4gl" data-vignesh-name="Frame 1739329117">
              <div className="vignesh-177saz6" data-vignesh-name="Frame 1739329113">
                <div data-vignesh-component-type="SVG" data-vignesh-name="DropHalf" parentsize="0" _constraints="[object Object]" rotation="0" shadows="" className="vignesh-yiiqcv" aria-hidden="true" style={{ imageRendering: "pixelated", flexShrink: "0", fill: "rgba(0,0,0,1)", color: "rgba(0,0,0,1)" }}>
                  <div className="svgContainer" style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
                    <svg style={{ width: "100%", height: "100%" }} viewBox="0 0 32 32">
                      <use href="#svg505509404_1807" />
                    </svg>
                  </div>
                </div>
            ...
            <div className="vignesh-5v6ya0" data-vignesh-name="Frame 1739329118">
              <div className="vignesh-4tvuf8" data-vignesh-name="Frame 1739329113">
                <div data-vignesh-component-type="SVG" data-vignesh-name="HandHeart" parentsize="0" _constraints="[object Object]" rotation="0" shadows="" className="vignesh-1cqul9t" aria-hidden="true" style={{ imageRendering: "pixelated", flexShrink: "0", fill: "rgba(0,0,0,1)", color: "rgba(0,0,0,1)" }}>
                  <div className="svgContainer" style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
                    <svg style={{ width: "100%", height: "100%" }} viewBox="0 0 32 32">
                      <use href="#svg-947975623_3415" />
                    </svg>
                  </div>
                </div>
          ...
          <div className="vignesh-1xu0swp">
            <div className="vignesh-hwjepf" data-vignesh-name="Frame 1739329120">
              <div className="vignesh-1ldt6qz" data-vignesh-name="Frame 1739329113">
                <div data-vignesh-component-type="SVG" data-vignesh-name="AlignCenterHorizontal" parentsize="0" _constraints="[object Object]" rotation="0" shadows="" className="vignesh-126t2v" aria-hidden="true" style={{ imageRendering: "pixelated", flexShrink: "0", fill: "rgba(0,0,0,1)", color: "rgba(0,0,0,1)" }}>
                  <div className="svgContainer" style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
                    <svg style={{ width: "100%", height: "100%" }} viewBox="0 0 32 32">
                      <use href="#svg923354926_1460" />
                    </svg>
                  </div>
                </div>
            ...
            <div className="vignesh-12iggru" data-vignesh-name="Frame 1739329119">
              <div className="vignesh-ltpntx" data-vignesh-name="Frame 1739329113">
                <div data-vignesh-component-type="SVG" data-vignesh-name="SpinnerBall" parentsize="0" _constraints="[object Object]" rotation="0" shadows="" className="vignesh-1oxu1hj" aria-hidden="true" style={{ imageRendering: "pixelated", flexShrink: "0", fill: "rgba(0,0,0,1)", color: "rgba(0,0,0,1)" }}>
                  <div className="svgContainer" style={{ width: "100%", height: "100%", aspectRatio: "inherit" }}>
                    <svg style={{ width: "100%", height: "100%" }} viewBox="0 0 32 32">
                      <use href="#svg-1852730311_1299" />
                    </svg>
                  </div>
                </div>
